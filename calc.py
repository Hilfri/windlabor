...
class Calculator():
    ...
    def get_formatted_data(self, filename, mps):
        ...
        if myConfig.get("t_amp"):
            ...
            max_1 = peakutils.indexes(df.voltage_1, thres=0.95, min_dist=sh)
            min_1 = peakutils.indexes(-df.voltage_1, thres=0.95, min_dist=sh)
            ...
            if myConfig.get("t_v_ac_2"):
                ...
                max_2 = peakutils.indexes(df.voltage_2, thres=0.95, min_dist=sh)
                min_2 = peakutils.indexes(-df.voltage_2, thres=0.95, min_dist=sh)
                for i in min_2:
                    if i-sh<0:
                        mini=1
                    else:
            ...
            if myConfig.get("t_v_ac_3"):
                ...
                max_3 = peakutils.indexes(df.voltage_3, thres=0.95, min_dist=sh)
                min_3 = peakutils.indexes(-df.voltage_3, thres=0.95, min_dist=sh)
